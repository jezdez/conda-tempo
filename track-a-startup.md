...
| **Status** | Implementation in progress — 16 of 25 Track A PRs merged; 9 in review, targeting 26.7 (July) |
...
| Date | Change |
|---|---|
| 2026-05-06 | **Track A status check (T+13 since 2026-04-23).** No PRs merged since last sweep — all 9 remain review-blocked. A19b [#15916](https://github.com/conda/conda/pull/15916) and A22 [#15893](https://github.com/conda/conda/pull/15893) confirmed `MERGEABLE` with active review threads from @dholth and @kenodegard. The other 7 show `UNKNOWN` mergeability (cosmetic drift, will need rebase when picked up). Track A missed the May release (26.5) due to review bandwidth — target moved to July release (26.7). Sprint review shortlist identified (ordered by diff size): A14 [#15887](https://github.com/conda/conda/pull/15887) (+45 −1), A8 [#15880](https://github.com/conda/conda/pull/15880) (+92 −6), A6 [#15877](https://github.com/conda/conda/pull/15877) (+112 −3), A22 [#15893](https://github.com/conda/conda/pull/15893) (+139 −97), A10 [#15882](https://github.com/conda/conda/pull/15882) (+171 −20). Remaining 4 (A2/A3, A9, A11, A19b) follow in subsequent sprint. Tracking ticket [#15867](https://github.com/conda/conda/issues/15867) updated with progress comment. No code changes. |
