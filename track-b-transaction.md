...
> topological-sort PR #16331 graphlib update; B13 cph merged; headline
...
uses stdlib `graphlib.TopologicalSorter` instead of carrying the local
prototype's child-adjacency Kahn pass, while preserving conda's
